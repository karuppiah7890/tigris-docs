...
✔ What is the url for your Tigris instance (default: localhost:8081) ? · api.preview.tigrisdata.cloud
...
🚀 [Signup](https://www.tigrisdata.com/beta) for the beta of Tigris Cloud - a
fully managed version of Tigris, and try out the open source developer data
