...
Every Tigris application is a project that with a dedicated database and cloud credentials. A project can have only one database assortiated with it. 
To create a Tigris project, [Login/Signup](https://tigris-webconsole-develop.vercel.app/) to your Tigris console and create a new project.
