---
title: "Create Next.js Application with Tigris"
---
...
Create a Next.js project using the Tigris starter template:
...
the next step and deploy it to production. Nextjs and Tigris can be deployed to multiple
