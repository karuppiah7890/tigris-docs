...
This tutorial also requires the [Netlify CLI](https://docs.netlify.com/cli/get-started/) to be installed.
...
For other operating systems: [See installation instructions here](https://www.tigrisdata.com/docs/sdkstools/cli/installation.mdx).
...
```json
{
  ...
  "project": "ecommerce_search"
}
```

The table below shows the mapping of JSON property ID to environment variable:
...
| project       | `TIGRIS_PROJECT`       |

Additionally, add the following to your environment variables:
