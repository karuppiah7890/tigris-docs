...
```mdx-code-block
<TerminalWindow>
<CodeBlock language="shell">tigris create app_key "my app key" --project=ecommerce_search</CodeBlock>
</TerminalWindow>
```
...
Once done, you can create a `.env` and copy the values from above.
