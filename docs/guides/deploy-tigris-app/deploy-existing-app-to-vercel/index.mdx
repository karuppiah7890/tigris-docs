---
title: Integrating Tigris into an application deployed to Vercel
---
...
Let's move on to configure your project's environment variables with your Tigris project credentials. To do this, first, collapse the environment variables box, and then copy and add your Tigris project credentials and their corresponding values from your `.env.local` file. To save a credential, click on the 'Add' button and repeat the process for the next one.
