...
- [Data modeling in TypeScript](@site/docs/sdkstools/typescript/database/datamodel.mdx)
- [Data modeling in Go](@site/docs/sdkstools/golang/database/datamodel.mdx)
- [Data modeling in Java](@site/docs/sdkstools/java/database/datamodel/declare.md)
