...
:::note
The collection type is set as "messages".
:::

### Subscribe to a Topic

Subscribe API can be used to subscribe to a topic. Subscribe to this topic in a different terminal like below.
...
Try this in a different terminal and send some orders like above that have status set as `canceled`.
