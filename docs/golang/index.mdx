...
_, err := catalog.Insert(ctx, &Catalog{Name: "fiona handbag", Price: 99.9, Brand: "michael kors", Labels: "purses", Popularity: 8})
if err != nil {
    // handle error
}

var product *Catalog
product, err = catalog.ReadOne(ctx, filter.Eq("Id", 1)) // find user with Id 1
if err != nil {
    // handle error
}
```
