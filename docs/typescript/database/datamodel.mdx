...
export class Catalog implements TigrisCollectionType {}
```
...
The [Tigris TypeScript client repository](https://github.com/tigrisdata/tigris-client-ts/tree/main/src/__tests__/data/decoratedModels)
