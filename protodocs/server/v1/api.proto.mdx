  ...
  message={{
    ...
    fields: [
      ...
      },
      {
        ...
        oneofdecl: "",
        defaultValue: "",
        typeLink: "/protodocs/server/v1/api.proto#collation",
      },
    ],
  }}
/>
      ...
      "google.api.http": {
        rules: [
          ...
          },
          {
            method: "POST",
            pattern:
              "/v1/databases/{db}/collections/{collection}/messages/read",
            body: "*",
          },
        ],
      },
      ...
      "google.api.http": {
        rules: [
          ...
          },
          {
            method: "POST",
            pattern:
              "/v1/databases/{db}/collections/{collection}/messages/search",
            body: "*",
          },
        ],
      },
...
<ProtoServiceMethod
  ...
  method={{
    ...
    options: {
      "google.api.http": {
        rules: [{ method: "POST", pattern: "/v1/databases/list" }],
      },
    },
...
<ProtoServiceMethod
  ...
  method={{
    ...
    options: {
      "google.api.http": {
        rules: [
          { method: "POST", pattern: "/v1/databases/{db}/create", body: "*" },
        ],
      },
    },
...
<ProtoServiceMethod
  ...
  method={{
    ...
    options: {
      "google.api.http": {
        rules: [
          { method: "DELETE", pattern: "/v1/databases/{db}/drop", body: "*" },
        ],
      },
    },
...
<ProtoServiceMethod
  ...
  method={{
    ...
    options: {
      "google.api.http": {
        rules: [
          { method: "POST", pattern: "/v1/databases/{db}/describe", body: "*" },
        ],
      },
    },
...
<ProtoServiceMethod
  ...
  method={{
    ...
    responseStreaming: false,
    options: {
      "google.api.http": { rules: [{ method: "GET", pattern: "/v1/info" }] },
    },
