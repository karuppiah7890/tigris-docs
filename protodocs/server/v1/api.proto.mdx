      ...
      "google.api.http": {
        rules: [
          ...
          },
          {
            method: "POST",
            pattern:
              "/api/v1/databases/{db}/collections/{collection}/messages/read",
            body: "*",
          },
        ],
      },
      ...
      "google.api.http": {
        rules: [
          ...
          },
          {
            method: "POST",
            pattern:
              "/api/v1/databases/{db}/collections/{collection}/messages/search",
            body: "*",
          },
        ],
      },
        ...
        rules: [
          {
            method: "POST",
            pattern:
              "/api/v1/databases/{db}/collections/{collection}/messages/publish",
            body: "*",
          },
        ],
      },
        ...
        rules: [
          {
            method: "POST",
            pattern:
              "/api/v1/databases/{db}/collections/{collection}/messages/subscribe",
            body: "*",
          },
        ],
      },
    ...
    fields: [
      {
        ...
        label: "",
        type: "CollectionType",
        longType: "CollectionType",
        fullType: "tigrisdata.v1.CollectionType",
        ismap: false,
        isoneof: false,
        oneofdecl: "",
        defaultValue: "",
        typeLink: "/protodocs/server/v1/api.proto#collectiontype",
      },
    ],
  }}
/>
  ...
  message={{
    ...
    fields: [
      ...
      },
      {
        ...
        oneofdecl: "",
        defaultValue: "",
        typeLink: "/protodocs/server/v1/api.proto#publishrequestoptions",
      },
    ],
  }}
/>
  ...
  message={{
    ...
    fields: [
      ...
      },
      {
        ...
        oneofdecl: "",
        defaultValue: "",
        typeLink: "/protodocs/server/v1/api.proto#subscriberequestoptions",
      },
    ],
  }}
/>
...
<ProtoEnum
  ...
  enumb={{
    name: "CollectionType",
    longName: "CollectionType",
    fullName: "tigrisdata.v1.CollectionType",
    description:
      "The type of this collection. Tigris supports Document based APIs for DOCUMENTS collection and Pub/Sub APIs for\nMESSAGES collection.",
    values: [
      { name: "DOCUMENTS", number: "0", description: "" },
      { name: "MESSAGES", number: "1", description: "" },
    ],
  }}
/>
