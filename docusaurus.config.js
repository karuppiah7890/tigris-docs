...
const openApiDocs = [
  "redocusaurus",
  {
    ...
    specs: [
      {
        id: "server-v1-api-openapi",
        spec: "external/tigris-api/server/v1/api_openapi.yaml",
      },
      {
        id: "server-v1-admin-openapi",
        spec: "external/tigris-api/server/v1/admin_openapi.yaml",
      },
      {
        id: "server-v1-auth-openapi",
        spec: "external/tigris-api/server/v1/auth_openapi.yaml",
      },
      {
        id: "server-v1-health-openapi",
        spec: "external/tigris-api/server/v1/health_openapi.yaml",
      },
      {
        id: "server-v1-observability-openapi",
        spec: "external/tigris-api/server/v1/observability_openapi.yaml",
      },
    ],
  ...
  plugins: [
    ...
    [
      "@docusaurus/plugin-content-docs",
      {
        id: "httpdocs",
        path: "httpdocs",
        routeBasePath: "httpdocs",
        sidebarPath: require.resolve("./httpdocs/sidebars.js"),
      },
    ],
  ],
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              {
                label: "HTTP",
                to: "httpdocs/server/v1/api",
                activeBasePath: "httpdocs",
              },
              {
                label: "RPC",
