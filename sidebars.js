    ...
    },
    {
      ...
      items: [
        "java/getting-started",
        {
          ...
          link: {
            type: "doc",
            id: "java/documents/documents",
          },
          collapsed: false,
          items: [
            "java/documents/datamodel",
            "java/documents/types",
            "java/documents/insert",
            "java/documents/update",
            "java/documents/delete",
            "java/documents/query",
            "java/documents/search",
            "java/documents/transactions",
          ],
        },
        {
          type: "category",
          ...
          link: {
            type: "doc",
            id: "java/events/events",
          },
          collapsed: true,
          items: [
            "java/events/datamodel",
            "java/events/publish_subscribe",
            "java/events/schema",
            "java/events/types",
          ],
        },
